...
class BMICalculatorTest {
	...
	class IsDietRecommendedTest {
		...
		@ParameterizedTest(name = "weight={0}, height=1.72")
		@ValueSource(doubles = { 89.0, 95.0, 110. })
		void should_ReturnTrue_When_DietRecommended_Using_ValueSource(Double coderWeight) {
			// given
		...
		void should_ReturnTrue_When_DietRecommended_Using_CsvSource(Double coderWeight, Double coderHeight) {
			// given
			double weight = coderWeight;
		...
		void should_ReturnTrue_When_DietRecommended_Using_CsvFileSource(Double coderWeight, Double coderHeight) {
			// given
			double weight = coderWeight;
			double height = coderHeight;
